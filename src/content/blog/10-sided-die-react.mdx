...
**Update:** 0.105 &asymp; tan 6&deg;. It's close enough that I suspect that's where the number came from. This means that each vertex has an altitude of &plusmn;6&deg; from the D10's equator.
