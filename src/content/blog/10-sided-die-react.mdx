...
<figure class="figure">
  <video width="720" height="438" controls loop>
    <source src="/src/assets/img/desmos-circle-720.mp4" type="video/mp4" />
  </video>
  <figcaption>
...
<figure class="figure">
  <video width="720" height="438" controls loop>
    <source src="/src/assets/img/mathbox-circle-720.mp4" type="video/mp4" />
  </video>
  <figcaption>
    Drawing a circle counterclockwise from the left with varying z-heights on{' '}
    <a href="https://christopherchudzicki.github.io/MathBox-Demos/parametric_curves_3D.html?settings=">
      MathBox
    </a>
  </figcaption>
</figure>
