...
import filetree from '../../assets/img/git-casing-filetree.png';
import commitDetail1 from '../../assets/img/git-casing-commit-detail-1.png';
import commitDetail2 from '../../assets/img/git-casing-commit-detail-2.png';
import naiveRename1 from '../../assets/img/git-casing-naive-rename-1.png';
import naiveRename2 from '../../assets/img/git-casing-naive-rename-2.png';
...
If I want to show a non-developer [my sweet side project](/blog/introducing-fretzone), I'm probably not going to get very far if I tell them to clone, build, and serve it themselves. For everyone's convenience, I knew early on that the app would have to be hosted somewhere.
...
<Image
  src={filetree}
  alt="Screenshot from Visual Studio Code's file explorer clearly showing that `src/components/ToolBar/Zoom.jsx` is a valid path."
/>
...
<Image
  src={commitDetail1}
  alt="Screenshot from GitHub showing the summary of a simple renaming commit I'd recently made. The inserted/deleted lines show that any imports referencing the folder `Toolbar` (with a lowercase 'b') now reference `Toolbar` (with a capital 'B'.)"
/>
...
<Image
  src={commitDetail2}
  alt="Screenshot from GitHub showing the file in question, `Zoom.jsx`. The parent folder name on GitHub is `Toolbar` with a lowercase 'b'."
/>
...
<Image
  src={naiveRename1}
  alt="Screenshot from Visual Studio Code's Source Control sidebar. The changes detected are that the file `about.md` has been deleted, and the file `aboot.md` has been added."
/>
...
<Image
  src={naiveRename2}
  alt="Screenshot from Visual Studio Code's Source Control sidebar. The change detected, which has been staged, is that some file was renamed to `aboot.md`."
/>
