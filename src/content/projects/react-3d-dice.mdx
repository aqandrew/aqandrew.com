...
The latest source code is [here](https://github.com/aqandrew/react-3d-dice). I encourage you to read the blog post for full context and detail.

I've been stuck on how to add textures to the dice since publishing that post, but I believe the way forward involves [decoding UV arrays in the source code I'm adapting](https://github.com/byWulf/threejs-dice/blob/fbefa73e0c7ec8d82a713a661839d229ff69c755/lib/dice.js#L319-L322).
