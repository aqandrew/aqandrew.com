...
I wrote reusable CSS utilities for Square seller testimonials and case studies.
...
Displaying the quote text as HTML elements (instead of embedding it in each image) kept the text accessible and responsive, and saved our production designers from having to do extra work.

<Image
  src={quoteArtybakerMd}
  alt="Artybaker's quote component (tablet screen size), with text in the upper right corner and a large border radius"
/>

<Image
  src={quoteMitoLg}
  alt="Mito's quote component (small desktop screen size), with text in the lower right corner and a small border radius"
/>
